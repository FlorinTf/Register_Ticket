        ...
        def pre():
            ...
            try:
                ...
                if first_name.get() in '!@#$%^&*()_+" "':
                    ...
                    messagebox.showerror("Error", "Please insert valid phone")
                elif ".com" not in email.get():
                    messagebox.showerror("Error", "Please insert valid e-mail adress")
                    ...
                    def send_email():
                        ...
                        with smtplib.SMTP_SSL('smtp.gmail.com', 465) as smtp:
                            smtp.login("mail2@gmail.com", EMAIL_PASSWORD)
